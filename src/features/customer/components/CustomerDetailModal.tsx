...
export default function CustomerDetailModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6 bg-slate-950/60 backdrop-blur-md transition-opacity duration-300">
      ...
      {/* Modal Container */}
      <div className="relative bg-slate-50 w-full max-w-5xl rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border border-white/20 flex flex-col max-h-[95vh] md:max-h-[90vh] z-10 animate-fade-in-up">
